...
INSERT INTO `faculty` (`id`, `user_alias`, `Name`, `designation`, `dept`, `semester`, `email`, `password`, `mobile`, `date`, `status`) VALUES
...
INSERT INTO `user` (`id`, `name`, `email`, `pass`, `mobile`, `dept`, `semester`, `gender`, `hobbies`, `image`, `dob`, `regid`) VALUES
