<?php
	...
	mysqli_query($conn,"update faculty set Name='$n',designation='$desg',dept='$dept',mobile='$mob',password='$pass', facid='$facid' where id='".$_GET['id']."'");	
    ...
    <div class="control-group form-group">
    	<div class="controls">
        	<label>Faculty ID:</label>
            	<input type="text" value="<?php echo @$res['facid'];?>" name="facid" class="form-control" required>
        </div>
   	</div>
	...
	<div class="control-group form-group">
    	<div class="controls">
        	<label>Department:</label>
					<select name="dept" class="form-control" required value="<?php echo @$res['dept'];?>" >
					<option></option>
					<option>IT</option>
					<option>ETC</option>
