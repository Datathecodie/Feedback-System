<?php 
include('../src/SentimentAnalyzer.php');
...
<!--		<th>Student</th>
		...
		<th>Quest5</th>
		<th>Suggestions</th>
        <th>AI Rating of Suggestions</th>
		</tr>
		</thead>
...
/*			echo "<td>".$row[1]."</td>";
            ...
            $sentimentAnalysisOfSentence1 = $sat->analyzeSentence($row[8]);
            ...
            $stars = intval($probabilityofSentence1BeingPositive*5)+1;
            echo "<td>".$stars."/5 Ratings ".$probabilityofSentence1BeingPositive."</td>";
