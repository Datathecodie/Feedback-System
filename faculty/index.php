...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar visible-sm visible-xs visible-lg visible-md">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="index.php?page=update_profile"><span class="glyphicon glyphicon-asterisk"></span> Update Profile</a></li>
			 <li><a href="index.php?page=feedback"><span class="glyphicon glyphicon-thumbs-down"></span>See Given Feedback</a></li>
                <li><a href="index.php?page=subject"><span class="glyphicon glyphicon-asterisk"></span> My Subjects</a></li>
              <li><a href="index.php?page=add_subject"><span class="glyphicon glyphicon-asterisk"></span> Add Subject</a></li>
          </ul>
        </div>
