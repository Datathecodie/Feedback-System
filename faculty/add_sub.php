<?php
	...
	mysqli_query($conn,"update faculty set Name='$n',designation	='$desg',dept='$prg',semester='$sem',mobile='$mob',	password='$pass' where email='".$_SESSION['faculty_login']."'");	
...
--><div class="col-lg-8" style="margin:15px;">
	...
	<div class="control-group form-group">
    	<div class="controls">
        	<label>dept:</label>
  <input type="text"  name="prg" value="<?php echo @$res['dept'];?>" class="form-control" required>
        </div>
    </div>
